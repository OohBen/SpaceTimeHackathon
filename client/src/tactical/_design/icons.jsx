/* ============================================================
   SOLAR DOMINION — Icons + original faction crests
...
const Crest = ({ faction, size }) =>
  faction === 'accord' ? <CrestAccord size={size} /> : <CrestImperium size={size} />;

Object.assign(window, { Icon, CrestImperium, CrestAccord, Crest });
