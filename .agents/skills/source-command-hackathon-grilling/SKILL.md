---
name: "source-command-hackathon-grilling"
description: "Interrogate to zero ambiguity. Returns structured brief."
---

# source-command-hackathon-grilling

Use this skill when the user asks to run the migrated source command `hackathon-grilling`.
