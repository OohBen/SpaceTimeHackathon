---
name: "source-command-hackathon-review"
description: "Review one PR. Check AC, post findings, decide merge/changes. Triggered internally or by human."
---

# source-command-hackathon-review

Use this skill when the user asks to run the migrated source command `hackathon-review`.
