---
name: "source-command-hackathon-verify"
description: "Epic finalization. Verify E2E, audit, merge Epic->Main (regular merge, NO squash)."
---

# source-command-hackathon-verify

Use this skill when the user asks to run the migrated source command `hackathon-verify`.
