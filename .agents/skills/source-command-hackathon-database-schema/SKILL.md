---
name: "source-command-hackathon-database-schema"
description: "Database schema guide. Normalization, PKs, indexes, FKs."
---

# source-command-hackathon-database-schema

Use this skill when the user asks to run the migrated source command `hackathon-database-schema`.
