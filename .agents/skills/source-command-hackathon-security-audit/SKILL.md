---
name: "source-command-hackathon-security-audit"
description: "Security scan. Secrets, SQLi, Auth. Blocks PRs on CRITICAL."
---

# source-command-hackathon-security-audit

Use this skill when the user asks to run the migrated source command `hackathon-security-audit`.
