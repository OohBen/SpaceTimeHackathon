---
name: "source-command-hackathon-decompose"
description: "Phase 3. Decompose epics into tasks. Auto-appends Verify task with success script."
---

# source-command-hackathon-decompose

Use this skill when the user asks to run the migrated source command `hackathon-decompose`.
