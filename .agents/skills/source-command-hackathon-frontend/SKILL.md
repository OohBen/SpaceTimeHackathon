---
name: "source-command-hackathon-frontend"
description: "Frontend implementation guide. A11y, state boundaries, components."
---

# source-command-hackathon-frontend

Use this skill when the user asks to run the migrated source command `hackathon-frontend`.
