---
name: "source-command-hackathon-projects"
description: "Track project status. Close completed projects."
---

# source-command-hackathon-projects

Use this skill when the user asks to run the migrated source command `hackathon-projects`.
