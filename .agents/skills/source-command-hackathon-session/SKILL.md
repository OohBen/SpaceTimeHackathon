---
name: "source-command-hackathon-session"
description: "Phase 4 Implementation. Claims ai-approved tasks, syncs, validates, implements, opens PR. Zero human escalation."
---

# source-command-hackathon-session

Use this skill when the user asks to run the migrated source command `hackathon-session`.
