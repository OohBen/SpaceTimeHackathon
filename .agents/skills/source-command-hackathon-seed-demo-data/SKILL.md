---
name: "source-command-hackathon-seed-demo-data"
description: "Generate fixture data + demo toggle."
---

# source-command-hackathon-seed-demo-data

Use this skill when the user asks to run the migrated source command `hackathon-seed-demo-data`.
