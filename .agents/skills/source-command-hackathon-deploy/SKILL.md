---
name: "source-command-hackathon-deploy"
description: "Deploy application. Dockerfile, CI/CD, ENV wiring."
---

# source-command-hackathon-deploy

Use this skill when the user asks to run the migrated source command `hackathon-deploy`.
