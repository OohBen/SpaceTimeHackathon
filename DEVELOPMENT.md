...
| `npm run spacetime:start` | Start local SpacetimeDB + publish module | ws://localhost:3000 |
...
│   ├── src/
│   │   ├── module.ts         Module entry point (spacetimedb/server)
...
Run after any schema change in `server/src/`:
